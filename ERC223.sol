...
import "https://github.com/FourchinCookei-Money/ERC223.sol";
import "https://github.com/FourchinCookei-Money/IERC223.sol";
import "https://github.com/FourchinCookei-Money/ERC223CustomFallback.sol";
...
contract ERC223Token is IERC223 {
     ...
     * @param _value Amount of tokens that will be transferred.
     */
    function Transfer(address indexed _from, address indexed _to, uint256 _value);
    function TransferData(bytes _data);
    {
